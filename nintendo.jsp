...
<tr>
	...
	<img class="header-image" src="images/nintendo.jpg" alt="Index Page Image" />
	    
	<table>
			<tr>
				<th>
					<img src = "images/wii.jpg" width = "200px" height = "200px" alt = "Wii">
				</th>
				<td>
					<p> Wii </p>
					<p> Price: $200 </p>
				...
				<td>
					<form class = "submit-button" method = "get" action = "addToCart.jsp">
						<input type = "hidden" name = "productName" value = "Wii">
						<input class = "submit-button" type = "submit" name = "Wii" value = "Add to Cart">
					</form>
					<form class = "submit-button" method = "get" action = "submitReview.jsp">
						<input type = "hidden" name = "productName" value = "Wii">
						<input class = "submit-button" type = "submit" name = "Wii" value = "Write Review">
					</form>
					<form class = "submit-button" method = "get" action = "viewReviews.jsp">
						<input type = "hidden" name = "productName" value = "Wii">
						<input class = "submit-button" type = "submit" name = "Wii" value = "View Reviews">
					</form>
				</td>
			</tr>
			...
			<tr>
				<th>
					<img src = "images/wii_u.jpg" width = "200" height = "200" alt = "Wii U">
				</th>
				<td>
					<p> Wii U </p>
					<p> Price: $250 </p>
				...
				<td>
					<form class = "submit-button" method = "get" action = "addToCart.jsp">
						<input type = "hidden" name = "productName" value = "Wii U">
						<input class = "submit-button" type = "submit" name = "Wii U" value = "Add to Cart">
					</form>
					<form class = "submit-button" method = "get" action = "submitReview.jsp">
						<input type = "hidden" name = "productName" value = "Wii U">
						<input class = "submit-button" type = "submit" name = "Wii U" value = "Write Review">
					</form>
					<form class = "submit-button" method = "get" action = "viewReviews.jsp">
						<input type = "hidden" name = "productName" value = "Wii U">
						<input class = "submit-button" type = "submit" name = "Wii U" value = "View Reviews">
					</form>
				</td>
			</tr>	
