...
<tr>
	...
	<img class="header-image" src="images/ttint.jpg" width = "100%" height = "-25" alt="Index Page Image" />
	    
	<table>
			<tr>
				<th>
					<img src = "images/gta5.jpg" width = "200px" height = "200px" alt = "XBOX One">
				</th>
				<td>
				...
				<td>
					<form class = "submit-button" method = "get" action = "addToCart.jsp">
						<input type = "hidden" name = "productName" value = "GTA V">
						<input class = "submit-button" type = "submit" name = "GTA V" value = "Add to Cart">
					</form>
					<form class = "submit-button" method = "get" action = "submitReview.jsp">
						<input type = "hidden" name = "productName" value = "GTA V">
						<input class = "submit-button" type = "submit" name = "GTA V" value = "Write Review">
					</form>
					<form class = "submit-button" method = "get" action = "viewReviews.jsp">
						<input type = "hidden" name = "productName" value = "GTA V">
						<input class = "submit-button" type = "submit" name = "GTA 5" value = "View Reviews">
					</form>
				</td>
			</tr>			
	</table>
