...
<div id="container">
    ...
    <form name="autofillform" action="autocomplete" autocomplete="off" class="searchform" >
				...
				<td><input class="img" type="image" src="images/search.png" height="20px" width="20px" alt="search" name="search"  /></td>
                               	</tr>
<tr>
...
<% 
	...
	out.println("<p class='invalid'>Review submitted successfully</p>");
	}
	if (request.getParameter("login") != null) {
	out.println("<p class='invalid'>Welcome</p>");
	}
    if (session.getAttribute("search") != null) {
    session.setAttribute("search", null);
	out.println("<p class='invalid'>No Such Products exist</p>");
	}
%> 
	<section id="content">
	...
	<img class="header-image" src="images/head.jpg" alt="Index Page Image" />
    
	<article><h3>Are you looking for a gaming kit?</h3>
		<p>You are at the right place, here you can find all the items for you to get a thrilled gaming experience.</p>
		<p>we provide gaming consoles manufactured by top brands like Microsoft, Sony, Nintendo.</p>
		<p>We keep updating our wide range of gamelist from game makers like EA, Activision, Take-two Interactive.</p>
		<p>We also provide supporting accessories for gaming.</p></article>
	<br><br>
	</section>
