...
<tr>
	...
	<img class="header-image" src="images/sony.jpg" width = "100%" height = "-25" alt="Index Page Image" />
  
	<table>
			<tr>
				<th>
					<img src = "images/ps3.jpg" width = "200px" height = "200px" alt = "PS3">
				</th>
				<td>
					<p> Play Station 3 </p>
					<p> Price: $450 </p>
				...
				<td>
					<form class = "submit-button" method = "get" action = "addToCart.jsp">
						<input type = "hidden" name = "productName" value = "PS 3">
						<input class = "submit-button" type = "submit" name = "PS 3" value = "Add to Cart">
					</form>
					<form class = "submit-button" method = "get" action = "submitReview.jsp">
						<input type = "hidden" name = "productName" value = "PS 3">
						<input class = "submit-button" type = "submit" name = "PS 3" value = "Write Review">
					</form>
					<form class = "submit-button" method = "get" action = "viewReviews.jsp">
						<input type = "hidden" name = "productName" value = "PS 3">
						<input class = "submit-button" type = "submit" name = "PS 3" value = "View Reviews">
					</form>
				</td>
			</tr>
			...
			<tr>
				<th>
					<img src = "images/ps4.jpg" width = "200" height = "200" alt = "PS4">
				</th>
				<td>
					<p> Play Station 4 </p>
					<p> Price: $550 </p>
				...
				<td>
					<form class = "submit-button" method = "get" action = "addToCart.jsp">
						<input type = "hidden" name = "productName" value = "PS 4">
						<input class = "submit-button" type = "submit" name = "PS 4" value = "Add to Cart">
					</form>
					<form class = "submit-button" method = "get" action = "submitReview.jsp">
						<input type = "hidden" name = "productName" value = "PS 4">
						<input class = "submit-button" type = "submit" name = "PS 4" value = "Write Review">
					</form>
					<form class = "submit-button" method = "get" action = "viewReviews.jsp">
						<input type = "hidden" name = "productName" value = "PS 4">
						<input class = "submit-button" type = "submit" name = "PS 4" value = "View Reviews">
					</form>
				</td>
			</tr>	
