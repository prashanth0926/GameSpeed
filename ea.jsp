...
<tr>
	...
	<img class="header-image" src="images/EA.jpg" width = "100%" height = "-25" alt="Index Page Image" />
	    
	<table>
			<tr>
				<th>
					<img src = "images/fifa16.jpg" width = "200px" height = "200px" alt = "XBOX One">
				</th>
				<td>
					<p> FIFA 16 </p>
					<p> Price: $75 </p>
				...
				<td>
					<form class = "submit-button" method = "get" action = "addToCart.jsp">
						<input type = "hidden" name = "productName" value = "FIFA 16">
						<input class = "submit-button" type = "submit" name = "FIFA 16" value = "Add to Cart">
					</form>
					<form class = "submit-button" method = "get" action = "submitReview.jsp">
						<input type = "hidden" name = "productName" value = "FIFA 16">
						<input class = "submit-button" type = "submit" name = "FIFA 16" value = "Write Review">
					</form>
					<form class = "submit-button" method = "get" action = "viewReviews.jsp">
						<input type = "hidden" name = "productName" value = "FIFA 16">
						<input class = "submit-button" type = "submit" name = "Fifa 16" value = "View Reviews">
					</form>
				</td>
			</tr>			
	</table>
