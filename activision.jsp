...
<tr>
	...
	<img class="header-image" src="images/activision.jpg" width = "100%" height = "-25" alt="Index Page Image" />
	    
	<table>
			<tr>
				<th>
					<img src = "images/cod_aw.jpg" width = "200px" height = "200px" alt = "XBOX One">
				</th>
				<td>
				...
				<td>
					<form class = "submit-button" method = "get" action = "addToCart.jsp">
						<input type = "hidden" name = "productName" value = "COD AW">
						<input class = "submit-button" type = "submit" name = "COD AW" value = "Add to Cart">
					</form>
					<form class = "submit-button" method = "get" action = "submitReview.jsp">
						<input type = "hidden" name = "productName" value = "COD AW">
						<input class = "submit-button" type = "submit" name = "COD AW" value = "Write Review">
					</form>
					<form class = "submit-button" method = "get" action = "viewReviews.jsp">
						<input type = "hidden" name = "productName" value = "COD AW">
						<input class = "submit-button" type = "submit" name = "COD AW" value = "View Reviews">
					</form>
				</td>
			</tr>			
	</table>
