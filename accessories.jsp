...
<tr>
	...
	<img class="header-image" src="images/acc.jpg" width = "100%" height = "-25" alt="Index Page Image" />
	    
	<table>
			<tr>
				<th>
					<img src = "images/sk.jpg" width = "200px" height = "200px" alt = "XBOX One">
				</th>
				<td>
					<p> Skullcandy Headset </p>
					<p> Price: $50 </p>
				</td>
				<td>
					<form class = "submit-button" method = "get" action = "addToCart.jsp">
						<input type = "hidden" name = "productName" value = "SK">
						<input class = "submit-button" type = "submit" name = "SK" value = "Add to Cart">
					</form>
					<form class = "submit-button" method = "get" action = "submitReview.jsp">
						<input type = "hidden" name = "productName" value = "SK">
						<input class = "submit-button" type = "submit" name = "SK" value = "Write Review">
					</form>
					<form class = "submit-button" method = "get" action = "viewReviews.jsp">
						<input type = "hidden" name = "productName" value = "SK">
						<input class = "submit-button" type = "submit" name = "SK" value = "View Reviews">
					</form>
				</td>
			</tr>			
	</table>
